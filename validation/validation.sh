...
cat hd | awk '{if(($1-$2)>10000 || ($1-$2)<-10000) print ($1-$2)}' > err
cat tl | awk '{if(($1-$2)>10000 || ($1-$2)<-10000) print ($1-$2)}' >> err
cat hd2 | awk '{if(($1-$2)>10000 || ($1-$2)<-10000) print ($1-$2)}' >> err
...
paste tmp val1 > vtmp
cat vtmp | awk '{if(($1-$2)>0.0001 || ($1-$2)<-0.0001) print ($1-$2)}' > err
