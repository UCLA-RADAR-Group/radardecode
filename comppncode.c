 ...
 *
 *      note that the array indices are used 1 to 16. we dimension the 
 *      array to be 17 and ignore shiftreg[0] 
 *history-
...
*/
        ...
        case 8:
               ...
               code_info->fdback[0]=4;
               code_info->fdback[1]=5;
               code_info->fdback[2]=6;
        ...
        while ((c = getopt(argc,argv,myoptions)) != -1){
          ...
          case 'c':
                   ...
                   *codenum =  (log((double)(codelen + 1)))/logOf2 + .5;
                   if ((*codenum < 1) || (*codenum > 16)) goto errout;
                   break;
          case 's':
