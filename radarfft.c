...
*/
	...
	*/
done: bytes_out = write(STDOUT,(char *)info.avgBuf,info.bytesOutReq);
...
*/
        ...
        char  *myoptions = "l:r:p:x:";   /* options to search for. :--> needs
                                            an argument*/
        char *USAGE =
   "Usage: radarfft  -l lenffts -r rangeBins -p packed(1-4) [-x freq offset (Hz based on 1 Hz)] ";
...
*/
		...
		pI->bytesOutReq=pI->bytesInpBlk/2; /* since we avg power*/
